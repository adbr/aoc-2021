...
procedure Day05 is
   ...
   function Overlaped_Points (File_Name : String) return Integer is
...
begin
   ...
   Put_Line ("Part 1:");
   Put_Line ("  Overlaped points:" & Overlaped_Points (Argument (1))'Img);
end Day05;
